...
Thanks for taking a look. This is a build-in-public project at version 0.6.1, so it is still moving and contributions of every kind are welcome: bug reports, questions, ideas, and code.
