...
This is a work-in-progress project (v0.6.1). The roadmap is deliberately loose, will grow, and the order can change based on what proves useful. Nothing here is a promise.
