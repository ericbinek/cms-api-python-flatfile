...
REQUIRED_FIELDS = {"name", "termCode", "inDefinedTermSet"}
SEARCHABLE_FIELDS = {"name", "description", "termCode"}
SORTABLE_FIELDS = {"dateCreated", "dateModified", "name", "description", "termCode", "url"}

# Properties whose combined value must be unique across the collection. Empty
# when the entity allows duplicates.
UNIQUE_KEY = ["termCode", "inDefinedTermSet"]

SYSTEM_FIELDS = {"id", "dateCreated", "dateModified", "@context", "@type"}

REF_COLLECTIONS = {"DefinedTermSet": "defined-term-sets.json"}
