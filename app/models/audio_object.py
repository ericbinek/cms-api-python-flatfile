...
SEARCHABLE_FIELDS = {"name", "description", "encodingFormat", "transcript"}
SORTABLE_FIELDS = {"dateCreated", "dateModified", "name", "description", "contentUrl", "encodingFormat", "duration", "transcript", "uploadDate"}
