...
SEARCHABLE_FIELDS = {"name", "caption", "description", "encodingFormat"}
SORTABLE_FIELDS = {"dateCreated", "dateModified", "name", "caption", "description", "contentUrl", "encodingFormat", "uploadDate", "license"}

# Properties whose combined value must be unique across the collection. Empty
# when the entity allows duplicates.
UNIQUE_KEY = ["contentUrl"]

SYSTEM_FIELDS = {"id", "dateCreated", "dateModified", "@context", "@type"}

REF_COLLECTIONS = {"Person": "persons.json"}
