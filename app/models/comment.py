...
REQUIRED_FIELDS = {"text", "author", "about"}
SEARCHABLE_FIELDS = {"text"}
SORTABLE_FIELDS = {"dateCreated", "dateModified", "text", "dateCreated", "dateModified", "upvoteCount", "downvoteCount", "creativeWorkStatus"}

SYSTEM_FIELDS = {"id", "dateCreated", "dateModified", "@context", "@type"}

REF_COLLECTIONS = {"Person": "persons.json", "BlogPosting": "blog-postings.json", "Comment": "comments.json"}
