...
SEARCHABLE_FIELDS = {"name", "givenName", "familyName", "alternateName", "email", "description", "jobTitle"}
SORTABLE_FIELDS = {"dateCreated", "dateModified", "name", "givenName", "familyName", "alternateName", "email", "url", "description", "jobTitle"}
