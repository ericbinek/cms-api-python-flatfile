...
SEARCHABLE_FIELDS = {"headline", "description", "text"}
SORTABLE_FIELDS = {"dateCreated", "dateModified", "headline", "description", "text", "datePublished", "dateModified", "dateCreated", "url", "creativeWorkStatus"}
...
REF_COLLECTIONS = {"Person": "persons.json", "Organization": "organizations.json", "ImageObject": "image-objects.json", "WebSite": "web-sites.json"}
